  ...
  return (
    <div className="col-md-2 mb-3 col-sm-12 ">
      <div className="card mr-4 mt-3">
        <img
          className="card-img-top imageSize clickable"
        ...
        <div className="card-body">
          ...
          <p className="card-text">
            <b>&euro; {props.product.price}</b>
          </p>
          <p className="card-text">
            {props.product.instock ? (
              <span className="inStock">in stock ({props.product.store})</span>
            ) : (
              <span className="outStock">
                out of stock ({props.product.store})
              </span>
            )}
          </p>
          {props.product.instock ? (
